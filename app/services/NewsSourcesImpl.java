                ...
                if (conn.getResponseCode() == 200) {
                    ...
                    for (JsonNode s : sources) {
                        SourceInfo info = new SourceInfo(
                                ...
                                List.of() // empty list of articles for now
                        );
                        result.add(info);
                    }
                }
